...
try {
    ...
    # Copy-BundleDirectory owns managed replacement so it can preserve
    # generated catalog packs under managed/locations across rebuilds.
    foreach ($Dir in @("webroot", "audio")) {
